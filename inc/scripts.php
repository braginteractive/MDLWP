...
function mdlwp_scripts() {
	...
	wp_enqueue_style( 'mdlwp-mdl-css', '//storage.googleapis.com/code.getmdl.io/1.0.3/material.'.$primary.'-'.$secondary.'.min.css' );
	...
	wp_enqueue_script( 'mdlwp-mdl-js', '//storage.googleapis.com/code.getmdl.io/1.0.3/material.min.js', array(), '1.0.3', true );
